...
const EditClassModal: React.FC<EditClassModalProps> = ({ classData, onClose, onClassUpdated }) => {
      ...
      <div className="glass rounded-2xl max-w-md w-full p-6 border border-white/20">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-lg font-bold text-gray-900 !text-gray-900">Edit Class</h2>
          </div>
          <button
            onClick={onClose}
